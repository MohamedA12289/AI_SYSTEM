  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex w-full">
      ...
      <Routes>
        ...
        <Route path="/project/:projectId" element={<ProjectWorkspacePage rightPanelOpen={rightPanelOpen} onToggleRightPanel={() => setRightPanelOpen((v) => !v)} assistantMode={assistantMode} onModeChange={handleModeChange} />} />
        ...
        <Route path="/self-upgrade" element={<SelfUpgradePage rightPanelOpen={rightPanelOpen} onToggleRightPanel={() => setRightPanelOpen((v) => !v)} assistantMode={assistantMode} onModeChange={handleModeChange} />} />
